...
export default function PostDetail({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <main className="max-w-3xl mx-auto p-8 bg-sky-50 text-sky-900 font-sans rounded-2xl shadow-xl border border-sky-200 mt-10 space-y-8">
            ...
            <article className="leading-relaxed whitespace-pre-wrap bg-white/80 rounded-xl p-5 border border-sky-100 shadow-inner">
                {post.content}
            </article>
